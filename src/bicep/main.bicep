...
param aksClusterEbpfDataplane string = ''
...
param blobStorageAccountName string = '${uniqueString(resourceGroup().id)}'
...
param hostName string = 'httpbin.local'
...
param originHostHeader string = hostName
...
param namespace string = 'httpbin'
...
module aksCluster 'aksCluster.bicep' = {
  ...
  params: {
    ...
    ebpfDataplane: aksClusterEbpfDataplane
...
// output frontDoorEndpointFqdn string = frontDoor.outputs.endpointFqdn
